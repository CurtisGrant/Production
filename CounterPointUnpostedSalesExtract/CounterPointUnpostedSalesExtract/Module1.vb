...
Module Module1
    ...
    Sub Main()
        ...
        Do
            Try
                theProcess = "Reading RCClient.GetXmlNamespace file"
        ...
        If Not ok Then
            ...
            el.WriteToErrorLog(message, stack, "Inital set up")
        End If
        ...
        Do
            Try
                ...
                sql = "CREATE TABLE #dtl (TRANS_ID varchar(30), SEQ_NO int, STORE varchar(10), LOCATION varchar(10), QTY decimal(18,4) NULL, " &
                    "ITEM varchar(30), DIM1 varchar(30), DIM2 varchar(30), dim3 varchar(30), COST decimal(18,4) NULL, RETAIL decimal(18,4) NULL, " &
        ...
        If Not ok Then
            Dim el As New CounterPointUnpostedSalesExtract.ErrorLogger
            el.WriteToErrorLog(message, stack, theProcess)
        End If
    End Sub
