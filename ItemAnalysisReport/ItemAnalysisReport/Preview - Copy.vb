...
Public Class Preview
    ...
    End Sub
    Friend Sub ShowResults(ByVal tbl As DataTable, ByVal ParamsTxt As String)
        Me.Location = New Point(50, 50)
        theVendor = Item_Analysis.vendorId
        vendorName = Item_Analysis.vendorName
        Item_Analysis.lblProcessing.Visible = False
        ...
        For i As Integer = 0 To dgv1.Columns.Count - 1
            If i <> 13 Then dgv1.Columns(i).ReadOnly = True
            If i > 3 And i < 18 Then
        ...
        dgv1.Columns(14).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
        dgv1.Columns(15).DefaultCellStyle.Format = "N2"
        dgv1.Columns(16).DefaultCellStyle.Format = "N2"
        dgv1.Columns(25).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
            ...
            For Each row In displayTable.Rows
                For c = 1 To displayTable.Columns.Count - 1
                    ...
                    If Not IsDBNull(oTest) Then
                        ...
                        If c = 15 Or c = 16 Then arr(r, c - 1) = Format(row.item(c), "###,###.00")
                        If c = 25 Then arr(r, c - 1) = Format(row.item(c), "###,###")
                    End If
                Next
                r += 1
            Next
