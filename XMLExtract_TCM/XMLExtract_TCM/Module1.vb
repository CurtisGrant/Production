...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            cpCon.Open()
            sql = "SELECT i.ITEM_NO, g.DIM_1_UPR AS DIM1, g.DIM_2_UPR AS DIM2, g.DIM_3_UPR AS DIM3, i.DESCR AS DESCRIPTION, " & _
                ...
                "gv.LB_MERCHANT_SKU AS CUSTOM1, i.PROF_COD_3 AS CUSTOM3, i.PROF_COD_5 AS CUSTOM5, i.ALT_1_UNIT AS UOM, i.ALT_1_NUMER AS BUYUNIT, " & _
        ...
        Try
            ...
            cpCon.Open()
            sql = "SELECT ITEM_NO, BARCOD_ID, DIM_1_UPR, DIM_2_UPR, DIM_3_UPR, BARCOD, SEQ_NO FROM IM_BARCOD"
            cmd = New SqlCommand(sql, cpCon)
            rdr = cmd.ExecuteReader
            While rdr.Read
