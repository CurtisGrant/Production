...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            cpCon.Open()
            sql = "SELECT i.ITEM_NO, g.DIM_1_UPR AS DIM1, g.DIM_2_UPR AS DIM2, g.DIM_3_UPR AS DIM3, " & _
                "DisplayLabel1 AS DIM1_DESCR, DisplayLabel2 AS DIM2_DESCR, DisplayLabel3 AS DIM3_DESCR, i.DESCR AS DESCRIPTION, " & _
                "i.VEND_ITEM_NO, pv.VEND_ITEM_NO AS povItem, i.ITEM_VEND_NO AS VENDOR_ID, " & _
                ...
                "CASE WHEN i.USR_LB_MERCHANT_SKU IS NOT NULL THEN i.USR_LB_MERCHANT_SKU ELSE gv.LB_MERCHANT_SKU END AS CUSTOM1, " & _
                "i.PROF_COD_3 AS CUSTOM3, i.PROF_COD_5 AS CUSTOM5, i.ALT_1_UNIT AS UOM, i.ALT_1_NUMER AS BUYUNIT, " & _
                "i.ALT_1_DENOM AS SELLUNIT, imn.NOTE_TXT, i.STAT AS STATUS, i.ITEM_TYP AS TYPE, i.STK_UNIT, pv.MIN_ORD_QTY, ORD_MULT FROM VI_IM_ITEM_WITH_INV_TOTS AS i " & _
                "LEFT JOIN VI_IM_ITEM_GRID_DIMS g ON g.ITEM_NO = i.ITEM_NO " & _
                "LEFT JOIN USR_VI_MAG_ITEM_GRID_VAL gv ON i.ITEM_NO = gv.ITEM_NO AND g.DIM_1_UPR = gv.DIM_1_UPR " & _
                "AND g.DIM_2_UPR = gv.DIM_2_UPR AND g.DIM_3_UPR = gv.DIM_3_UPR " & _
